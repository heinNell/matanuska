...
export class SyncService {
  ...
  private tripUnsubscribes = new Map<string, () => void>();
  private dieselUnsubscribes = new Map<string, () => void>();
  private driverBehaviorUnsubscribes = new Map<string, () => void>();
  private globalUnsubscribes = new Map<string, Unsubscribe>();
  private auditLogUnsubscribes = new Map<string, () => void>();
  private jobCardUnsubscribes = new Map<string, () => void>();
  private enhancedJobCardUnsubscribes = new Map<string, () => void>();
  private tyreUnsubscribes = new Map<string, () => void>();
