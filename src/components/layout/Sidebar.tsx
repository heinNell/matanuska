...
const navSections: NavSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Carbon Footprint Calc", path: "/diesel/carbon-footprint" },
    ],
  },
  {
    title: "Drivers",
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Workshop Operations", path: "/workshop/operations" },
      { name: "Job Card Kanban", path: "/workshop/job-card-kanban" },
      { name: "New Job Card", path: "/workshop/new-job-card" },
      { name: "Inspections", path: "/workshop/inspections" },
      { name: "Stock Inventory", path: "/workshop/inventory" },
      { name: "Purchase Orders", path: "/workshop/purchase-orders" },
      { name: "Vendors", path: "/workshop/vendors" },
      { name: "QR Scanner", path: "/workshop/qr-scanner" },
      { name: "QR Generator", path: "/workshop/qr-generator" },
      { name: "Report Incident", path: "/workshop/report-incident" },
      { name: "Workshop Analytics", path: "/workshop/analytics" },
    ],
  },
  {
    title: "Tyres",
    items: [
      ...
      { name: "Management View", path: "/tyres/management-view" },
    ],
  },
  {
